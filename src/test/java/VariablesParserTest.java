...
class VariablesParserTest {
    ...
    void testParseHappy() {
        ...
        try {
            ...
            assertEquals("Line starts not with VarType, line should starts with VarType followed by var name enclosed by semicolon", e.getMessage());
        }
    }
    ...
    void testValidateVarNameUnhappy() {
        ...
        try {
            ...
            assertFalse(e.getMessage().equals("line should be enclosed with semicolon"));
        }
    }
